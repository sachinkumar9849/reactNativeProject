            ...
            <ScrollView className='bg-white px-7 pt-10 pb-36'>
                <View >
                    ...
                    {loading ? (
                        ...
                        data?.myDetail.education.map((experience) => (
                            <View key={experience.id} className='border rounded-md border-[#B5B3B3] p-4 mt-4 flex flex-row justify-between'>
                                <View className='' style={styles.textBlock}>
                                    <Text className='text-[18px] font-normal'>{experience.school}</Text>
                                    <View className='flex flex-row mt-4'>
                                        <Text className='text-[#0A0A0B] text-[14px]'>{experience.degree} </Text>
                                        <Text className='text-[#0A0A0B] text-[14px]'>"{experience.field_of_study}" </Text>
