...
const AddExperience = () => {
    ...
    const AddExperience = () => {
        router.push("/add-certifications-form")
    }
            ...
            <ScrollView className='bg-white px-7 pt-10'>
                <View>
                    ...
                    <View className="flex flex-row items-center">
                        <TouchableOpacity onPress={() => router.push("/show-education")}>
                    ...
                    <View className='flex justify-center w-full items-center mt-10'>
                        <Image source={images.certificate} />
                    </View>
                    <View className='mt-7'>
                        <SkillTitle titleSkill="Showcase Your Certifications!" />
